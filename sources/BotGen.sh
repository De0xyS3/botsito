...
function_verify () {
  permited=$(curl -sSL "https://raw.githubusercontent.com/hhportugames/botsito/main/Control/Control-Bot")
...
[[ ! -e "/bin/ShellBot.sh" ]] && wget -O /bin/ShellBot.sh https://raw.githubusercontent.com/hhportugames/botsito/main/ShellBot.sh &> /dev/null
...
ShellBot.InlineKeyboardButton --button 'botao_user' --line 2 --text ' Contacto 📲' --callback_data  '1' --url 'https://wa.me/593987072611'
